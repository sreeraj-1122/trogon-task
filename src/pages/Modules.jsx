...
const Modules = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center p-8 bg-purple-700">
      {/* Back Arrow Button */}
      <button 
        onClick={() => navigate(-1)} 
      ...
      <div className="grid md:grid-cols-4 lg:grid-cols-8 grid-cols-1 gap-4 md:gap-11 relative flex-wrap">
        {modules.map((module, index) => (
          <React.Fragment key={module.id}>
            <div
              className="w-48 h-20 flex items-center justify-center bg-white rounded-lg shadow-md text-center cursor-pointer"
